...
<div class="row">
<div class="col-md-6">
另一方面，我們也希望您能將[此問卷](https://docs.google.com/forms/d/e/1FAIpQLSeCZpWjEEcK7sE7qBoO8BIem3M79iz5NB-7FIcaGgvytakQ2A/viewform)分享給其他親朋好友，讓此網頁的根據更有代表性，我們才能說出更可信的故事。
</div>
...
<p>
多年來的國語政策施行，包含許多對方言之使用限制，如禁止於學校使用方言、限制廣播及電視節目的方言使用等，讓華語(國語)的使用率持續提高。
</p>
')
...
<ol>
  <li>用於正式、公眾場合，如學校教育、新聞媒體、公司等</li>
  <li>具有正式的文字書寫系統，並由通常有專門機構(如教育部)對其進行規定</li>
  <li>「位階」較高：由於語言與較高的社會階級(統治階級或受過高等教育之階級)結合，不同語言之間在人們心中開始出現<b>位階的差異</b>。統治階級的語言被認為較「高等」，而一般用於非正式場合(家中)的當地語言則被認為較「低等」、「不登大雅之堂」。</li>
</ol>
</p>

<p>
語言位階的出現，對處於弱勢、屬於「低位階」的方言帶來相當程度的衝擊。為追求較佳的生活環境或更高的社會地位，勢必增加使用「高位階」的語言、減少使用「低位階」的方言。例如，許多資料皆顯示臺灣教育程度與方言能力之間的負向關聯：<b>教育程度越高，方言能力越低</b> (如〈客語使用狀況調查〉,頁 35；《原住民族語言調查研究三年實施計畫：16 族綜合比較報告》)。
</p>
')
...
## 為何關注方言流失？
<br>
臺灣是個多語社會，我們有豐富多樣的南島語(原住民語言)、閩南語、客家語、華語以及東南亞語言。多語現象對於臺灣非常珍貴：

> 每種語言背後代表著一個獨特的族群與文化，這正是臺灣最重要的資產 --- 透過接受各個族群文化，我們能從多元的社會中獲得靈感不斷創新。而創新是臺灣這資源稀少的國家，在面對來自世界的各種挑戰時，能生存下去最重要的方式之一。

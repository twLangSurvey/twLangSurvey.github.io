...
```{r, fig.margin=TRUE}
knitr::include_graphics("./out_graph/facet_static_map.png")
```
...
```{r lang-map-modal2}
##### Modal Trigger Button #####
button_bs("語言地圖", class = "default pull-left btn-xs", data_toggle = "modal", data_target = "#lang-map2")
modal(id="lang-map2", modal_header = "語言地圖", modal_body=content)
```
<br>
</div><!--age-group div -->
</div><!-- tab-content div -->

...
這個網頁的原始碼託管於 [GitHub](https://github.com/twLangSurvey/twLangSurvey.github.io)，每週會自動更新一次。  
問卷調查的資料 可[點此下載](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/twLangSurvey/twlangsurvey.github.io/blob/master/data/survey.csv) (也是每週更新)，並在[這裡](https://github.com/twLangSurvey/twLangSurvey.github.io/blob/source/README.md)查看變項說明。
